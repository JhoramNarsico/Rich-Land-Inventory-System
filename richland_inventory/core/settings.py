...
# DEBUG is False by default, but can be overridden by the .env file for local development.
...
# The default is your local MySQL database from your .env file
DATABASES = {
    'default': {
...
# This code block checks if it exists and, if so, overrides the default database
# configuration to use Render's PostgreSQL database.
DATABASE_URL = os.environ.get('DATABASE_URL')
if DATABASE_URL:
    DATABASES['default'] = dj_database_url.config(
        conn_max_age=600,
        ssl_require=True # Required for secure connection to Render's database
    )
...
# Use Whitenoise to store and serve compressed static files.
